...
export default function Footer() {
  const footerLinks = {
    ...
    Resources: ["Blog", "Help Center", "Documentation", "API"],
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-white font-bold text-xl">ModernSite</span>
              </div>
            ...
            >
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="w-10 h-10 bg-slate-800 hover:bg-purple-600 rounded-full flex items-center justify-center text-gray-400 hover:text-white transition-all duration-200"
                >
                  {social.icon}
                </motion.a>
              ))}
